...
Disk impact: ~1.5 GB of packages + ~3 GB of Zero123++ weights on
first benchmark run. Skip the step entirely if you're not benchmarking
— v0.3's regular generation pipeline doesn't need any of it.
